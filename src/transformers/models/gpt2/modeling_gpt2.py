...
class GPT2Attention(nn.Module):
    ...
    def _attn(self, query, key, value, attention_mask=None, head_mask=None):
        ...
        # Layer-wise attention scaling #Not used
    ...
    def _alt_attn(self, query, key, value, attention_mask=None, head_mask=None):
        attn_weights = torch.matmul(query, key.transpose(-1, -2))
        #print(query.shape)
    ...
    def forward(
        ...
        if self.layer_idx == 0:
            print(f"Attention Layer 0 | attn_output: {attn_output.shape} | attn_weight: {attn_weights.shape}.")
...
class GPT2LMHeadModel(GPT2PreTrainedModel):
    ...
    def forward(
        ...
        #print(f'Works for LMHeadModel?: {test}')
